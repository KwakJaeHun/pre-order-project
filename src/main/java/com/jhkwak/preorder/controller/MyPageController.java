...
public class MyPageController {
    ...
    // 메인
    @GetMapping("")
    public ResponseEntity<?> signup(@CookieValue(value = JwtUtil.AUTHORIZATION_HEADER, required = false) String tokenValue){

        boolean jwtValidate = jwtUtil.validateToken(tokenValue);
